...
@HiltAndroidApp
class ComboApplication : Application() {
    //Get a global scope for all coroutines
//    val applicationScope = CoroutineScope(SupervisorJob())
//
//    // Inject scope and application context into singleton database
//    val database by lazy{ ComboRoomDatabase.getDatabase(this, applicationScope) }
//
...
//    val repository by lazy{ UserRepository.getInstance(database.comboDao(), applicationScope) }
}